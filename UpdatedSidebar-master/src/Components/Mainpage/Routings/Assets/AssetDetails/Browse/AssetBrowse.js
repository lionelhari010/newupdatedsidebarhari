...
import AccordionBrowse from "../../component/accordions/browse/AccordionBrowse";
  ...
  return (
    <>
      <div className={classes.main_container}>
        <div className="containers d-flex flex-row justify-content-between align-items-center ">
          <div className="d-flex align-items-center ">
            <BsSliders className="top-section-asset-icon" />
            <h1 className="top-section-heading">Assets - Browse</h1>
          </div>
          <div>
